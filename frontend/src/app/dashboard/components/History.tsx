        ...
        {patientId === '' && (
          <>
            <div className="w-full flex items-center justify-center">
              ...
              creating one. Or you can find your patient by searching from the
              left.
            </div>
          </>
        )}
                  ...
                  <div className="border rounded-xl bg-white p-4 flex flex-col gap-4">
                    ...
                    <div className="flex gap-8 items-center">
                      ...
                      >
                        ...
                        <div
                          className={`${header == 'notes' ? 'border-b-2 border-indigo-500' : ''} font-semibold text-gray-500 `}
                        >
                          Notes
                        </div>
                      </button>
                      ...
                      >
                        ...
                        <div
                          className={`${header == 'qr-code' ? 'border-b-2 border-indigo-500' : ''} font-semibold text-gray-500 flex flex-row gap-2 items-center`}
                        >
                          QR Code
                        </div>
                      </button>
                      ...
                      >
                        ...
                        <div
                          className={`${header == 'patient_data' ? 'border-b-2 border-indigo-500' : ''} font-semibold text-gray-500 flex flex-row gap-2 items-center`}
                        >
                          Patient data
                        </div>
                      </button>
